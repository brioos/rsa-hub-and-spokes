# -*- coding: utf-8 -*-
"""
Created on Mon Mar 10 22:40:08 2025
...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 10 22:35:19 2025
...
def GLMsingleWrapper(expid, ParticipantID, inputf):
    ...
    if not os.path.exists(participant_fmri_folder):
        print("Nonexistant inputfile. Skipping...")
        return
...
if __name__ == "__main__":
    ...
    for idx, (expid, participant_id) in enumerate(expid_mrid_map.items()):
        if idx % 3 != 1:
            continue 
    ...
    print("Processing complete! - Part2")
